// Run this script in Photoshop to save all text layers into a subtitles file.
// This should make it easy to add subtitles to your comic, and give you a template from which you can add subtitles for other languages easily.
...
var saveFile=new File(app.activeDocument.path+'/'+app.activeDocument.name.replace(/\..+$/,'.vtt'));
saveFile.open("w");
