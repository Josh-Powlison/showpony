...
,properties:{
	...
	,'currentQuality':					'The file quality we\'re currently targeting. If this level of quality isn\'t available, we\'ll pick the next highest one.'
	...
	,'files':							'An array of all of the files\' data.'
		,'files.#':						'A file.'
			...
			,'files.#.quality':			'The maximum quality level available for this file. Default is <em>0</em>. <em>0</em> is\'nt bad, it\'s just default.'
	...
	,'maxQuality':						'The maximum quality this module has available in its files. <em>0</em> isn\'t bad, it just means there\'s only one level of quality.'
	...
	,'notice':							'Pops up a notice for Showpony, usually for special functionality or if there\'s an error.'
		,'notice(message)':				'The notice text.'
	...
	,'readingDirection':				'Defaults to <em>"left-to-right"</em> but can also be "right-to-left", like for manga.'
	...
	,'saves':							'Contains info on the save data. Some of the data is also copied to cookies so it can be read on the server-side (like story language and bookmark system).'
		...
		,'saves.language':				'The language we\'re currently viewing the Showpony in. Gets autosaved.'
		...
		,'saves.local':					'Local save files.'
			...
			,'saves.local.*.quality':	'The file quality level for the save.'
	...
	,'subtitles':						'Contains supported languages and paths to those language\'s subtitles.'
		,'subtitles.*':					'A subtitles language.'
		,'subtitles.*.#':				'Subtitles for the corresponding language and file.'
	,'to':								'Go to a place in a Showpony file.'
		,'to(obj)':				'Pass an object like so: showpony.to({file:\'15\',time:\'2\'}). You can go to an exact position or relative position, and base it on file, time, or both. You can also write times as timestamps ("1:15:00", or 1 hour, 15 minutes). Relative values need to be prepended with	 a + or a - sign.'
